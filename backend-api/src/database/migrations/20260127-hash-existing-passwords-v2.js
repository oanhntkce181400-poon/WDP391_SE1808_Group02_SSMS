...
async function up({ mongoose }) {
  ...
  console.log(`[migration] V2 hashed ${updatedCount} user password(s).`);
}
...
module.exports = {
  id: '20260127-hash-existing-passwords-v2',
  description: 'Hash any remaining plain-text passwords after admin seeding fixes.',
  up,
  down,
};

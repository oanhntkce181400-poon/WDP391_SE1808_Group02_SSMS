      ...
      <main className="flex justify-center py-8">
        <div className="layout-content-container flex w-full max-w-[1280px] flex-col gap-6 px-6">
          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            ...
            <button
              className="flex h-11 min-w-[180px] items-center justify-center gap-2 rounded-lg bg-[#1A237E] px-6 text-sm font-bold text-white shadow-sm transition-all hover:bg-[#0D147A]"
              onClick={() => {
                setSelectedRoom(null);
                setIsModalOpen(true);
              }}

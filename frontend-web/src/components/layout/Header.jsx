  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap bg-[#1A237E] px-4 py-2.5 text-white shadow-md lg:px-6">
      <div className="flex items-center gap-4 lg:gap-6">
        <Link to={homeLink} className="flex items-center gap-2 transition-opacity hover:opacity-80 lg:gap-3">
          ...
          <div className="hidden leading-tight md:block">
            ...
            <p className="text-[8px] font-medium tracking-widest text-slate-300 lg:text-[10px]">{subtitleText}</p>
          </div>
        </Link>

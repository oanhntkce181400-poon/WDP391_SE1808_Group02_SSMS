...
function normalizeRole(value) {
  ...
  return role === "teacher" ? "lecturer" : role;
}

export default function Header({ mode = "admin" }) {
  ...
  const moreNav = isTeacherMode
    ...
    : [
        ...
        { label: "Báo cáo doanh thu", href: "/admin/revenue-report" },
      ...
      <div className="flex items-center gap-4 lg:gap-6">
        ...
        >
          ...
          <div className="hidden leading-tight md:block">
            <h2 className="text-sm font-bold uppercase tracking-tight text-white lg:text-base">
              SSMS
            </h2>
            <p className="text-[8px] font-medium tracking-widest text-slate-300 lg:text-[10px]">
              {subtitleText}
            </p>
          </div>
        </Link>
          ...
          {!isTeacherMode ? (
            <div ref={moreRef} className="relative">
              ...
              >
                Thêm
                <span
                  className={`text-[10px] transition-transform ${isMoreOpen ? "scale-y-[-1]" : ""}`}
                >
                  ▼
                </span>
              </button>
